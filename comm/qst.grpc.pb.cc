...
::grpc::Status Interact::Stub::RunApp(::grpc::ClientContext* context, const ::qst::AppID& request, ::qst::Empty* response) {
  return ::grpc::internal::BlockingUnaryCall< ::qst::AppID, ::qst::Empty, ::grpc::protobuf::MessageLite, ::grpc::protobuf::MessageLite>(channel_.get(), rpcmethod_RunApp_, context, request, response);
}

void Interact::Stub::async::RunApp(::grpc::ClientContext* context, const ::qst::AppID* request, ::qst::Empty* response, std::function<void(::grpc::Status)> f) {
  ::grpc::internal::CallbackUnaryCall< ::qst::AppID, ::qst::Empty, ::grpc::protobuf::MessageLite, ::grpc::protobuf::MessageLite>(stub_->channel_.get(), stub_->rpcmethod_RunApp_, context, request, response, std::move(f));
}

void Interact::Stub::async::RunApp(::grpc::ClientContext* context, const ::qst::AppID* request, ::qst::Empty* response, ::grpc::ClientUnaryReactor* reactor) {
...
::grpc::ClientAsyncResponseReader< ::qst::Empty>* Interact::Stub::PrepareAsyncRunAppRaw(::grpc::ClientContext* context, const ::qst::AppID& request, ::grpc::CompletionQueue* cq) {
  return ::grpc::internal::ClientAsyncResponseReaderHelper::Create< ::qst::Empty, ::qst::AppID, ::grpc::protobuf::MessageLite, ::grpc::protobuf::MessageLite>(channel_.get(), cq, rpcmethod_RunApp_, context, request);
}

::grpc::ClientAsyncResponseReader< ::qst::Empty>* Interact::Stub::AsyncRunAppRaw(::grpc::ClientContext* context, const ::qst::AppID& request, ::grpc::CompletionQueue* cq) {
  auto* result =
...
Interact::Service::Service() {
  ...
  AddMethod(new ::grpc::internal::RpcServiceMethod(
      ...
      ::grpc::internal::RpcMethod::NORMAL_RPC,
      new ::grpc::internal::RpcMethodHandler< Interact::Service, ::qst::AppID, ::qst::Empty, ::grpc::protobuf::MessageLite, ::grpc::protobuf::MessageLite>(
          [](Interact::Service* service,
             ::grpc::ServerContext* ctx,
             const ::qst::AppID* req,
             ::qst::Empty* resp) {
...
::grpc::Status Interact::Service::RunApp(::grpc::ServerContext* context, const ::qst::AppID* request, ::qst::Empty* response) {
  (void) context;
  (void) request;
  (void) response;
  return ::grpc::Status(::grpc::StatusCode::UNIMPLEMENTED, "");
