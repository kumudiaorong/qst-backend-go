 ...
 public:
  ...
  class StubInterface {
   public:
    ...
    virtual ::grpc::Status RunApp(::grpc::ClientContext* context, const ::qst::AppID& request, ::qst::Empty* response) = 0;
    std::unique_ptr< ::grpc::ClientAsyncResponseReaderInterface< ::qst::Empty>> AsyncRunApp(::grpc::ClientContext* context, const ::qst::AppID& request, ::grpc::CompletionQueue* cq) {
      return std::unique_ptr< ::grpc::ClientAsyncResponseReaderInterface< ::qst::Empty>>(AsyncRunAppRaw(context, request, cq));
    }
    std::unique_ptr< ::grpc::ClientAsyncResponseReaderInterface< ::qst::Empty>> PrepareAsyncRunApp(::grpc::ClientContext* context, const ::qst::AppID& request, ::grpc::CompletionQueue* cq) {
    ...
    class async_interface {
     public:
      ...
      virtual void RunApp(::grpc::ClientContext* context, const ::qst::AppID* request, ::qst::Empty* response, std::function<void(::grpc::Status)>) = 0;
      virtual void RunApp(::grpc::ClientContext* context, const ::qst::AppID* request, ::qst::Empty* response, ::grpc::ClientUnaryReactor* reactor) = 0;
    };
   ...
   private:
    ...
    virtual ::grpc::ClientAsyncResponseReaderInterface< ::qst::Empty>* AsyncRunAppRaw(::grpc::ClientContext* context, const ::qst::AppID& request, ::grpc::CompletionQueue* cq) = 0;
    virtual ::grpc::ClientAsyncResponseReaderInterface< ::qst::Empty>* PrepareAsyncRunAppRaw(::grpc::ClientContext* context, const ::qst::AppID& request, ::grpc::CompletionQueue* cq) = 0;
  };
  class Stub final : public StubInterface {
   public:
    ...
    ::grpc::Status RunApp(::grpc::ClientContext* context, const ::qst::AppID& request, ::qst::Empty* response) override;
    std::unique_ptr< ::grpc::ClientAsyncResponseReader< ::qst::Empty>> AsyncRunApp(::grpc::ClientContext* context, const ::qst::AppID& request, ::grpc::CompletionQueue* cq) {
      return std::unique_ptr< ::grpc::ClientAsyncResponseReader< ::qst::Empty>>(AsyncRunAppRaw(context, request, cq));
    }
    std::unique_ptr< ::grpc::ClientAsyncResponseReader< ::qst::Empty>> PrepareAsyncRunApp(::grpc::ClientContext* context, const ::qst::AppID& request, ::grpc::CompletionQueue* cq) {
    ...
    class async final :
     ...
     public:
      ...
      void RunApp(::grpc::ClientContext* context, const ::qst::AppID* request, ::qst::Empty* response, std::function<void(::grpc::Status)>) override;
      void RunApp(::grpc::ClientContext* context, const ::qst::AppID* request, ::qst::Empty* response, ::grpc::ClientUnaryReactor* reactor) override;
     private:
      friend class Stub;
   ...
   private:
    ...
    ::grpc::ClientAsyncResponseReader< ::qst::Empty>* AsyncRunAppRaw(::grpc::ClientContext* context, const ::qst::AppID& request, ::grpc::CompletionQueue* cq) override;
    ::grpc::ClientAsyncResponseReader< ::qst::Empty>* PrepareAsyncRunAppRaw(::grpc::ClientContext* context, const ::qst::AppID& request, ::grpc::CompletionQueue* cq) override;
  ...
  class Service : public ::grpc::Service {
   public:
    ...
    virtual ::grpc::Status RunApp(::grpc::ServerContext* context, const ::qst::AppID* request, ::qst::Empty* response);
  };
  ...
  class WithAsyncMethod_RunApp : public BaseClass {
   ...
   public:
    ...
    // disable synchronous version of this method
    ::grpc::Status RunApp(::grpc::ServerContext* /*context*/, const ::qst::AppID* /*request*/, ::qst::Empty* /*response*/) override {
      abort();
      return ::grpc::Status(::grpc::StatusCode::UNIMPLEMENTED, "");
    }
    void RequestRunApp(::grpc::ServerContext* context, ::qst::AppID* request, ::grpc::ServerAsyncResponseWriter< ::qst::Empty>* response, ::grpc::CompletionQueue* new_call_cq, ::grpc::ServerCompletionQueue* notification_cq, void *tag) {
   ...
   public:
    WithCallbackMethod_RunApp() {
      ::grpc::Service::MarkMethodCallback(2,
          new ::grpc::internal::CallbackUnaryHandler< ::qst::AppID, ::qst::Empty>(
            [this](
                   ::grpc::CallbackServerContext* context, const ::qst::AppID* request, ::qst::Empty* response) { return this->RunApp(context, request, response); }));}
    void SetMessageAllocatorFor_RunApp(
        ::grpc::MessageAllocator< ::qst::AppID, ::qst::Empty>* allocator) {
      ::grpc::internal::MethodHandler* const handler = ::grpc::Service::GetHandler(2);
      static_cast<::grpc::internal::CallbackUnaryHandler< ::qst::AppID, ::qst::Empty>*>(handler)
              ->SetMessageAllocator(allocator);
    }
    ...
    virtual ::grpc::ServerUnaryReactor* RunApp(
      ::grpc::CallbackServerContext* /*context*/, const ::qst::AppID* /*request*/, ::qst::Empty* /*response*/)  { return nullptr; }
  };
  ...
  class WithStreamedUnaryMethod_RunApp : public BaseClass {
   ...
   public:
    ...
    // replace default version of method with streamed unary
    virtual ::grpc::Status StreamedRunApp(::grpc::ServerContext* context, ::grpc::ServerUnaryStreamer< ::qst::AppID,::qst::Empty>* server_unary_streamer) = 0;
  };
