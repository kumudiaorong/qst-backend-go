...
extern AppIDDefaultTypeInternal _AppID_default_instance_;
class AppInfo;
...
PROTOBUF_NAMESPACE_OPEN
template <>
::qst::AppID* Arena::CreateMaybeMessage<::qst::AppID>(Arena*);
template <>
...
class AppID final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:qst.AppID) */ {
 public:
  inline AppID() : AppID(nullptr) {}
  ~AppID() override;
  template<typename = void>
  explicit PROTOBUF_CONSTEXPR AppID(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);

  AppID(const AppID& from);
  AppID(AppID&& from) noexcept
    : AppID() {
    *this = ::std::move(from);
  }
  ...
  inline AppID& operator=(AppID&& from) noexcept {
    if (this == &from) return *this;
    if (GetOwningArena() == from.GetOwningArena()
  #ifdef PROTOBUF_FORCE_COPY_IN_MOVE
        && GetOwningArena() != nullptr
  ...
  static inline const AppID* internal_default_instance() {
    return reinterpret_cast<const AppID*>(
               &_AppID_default_instance_);
  }
  static constexpr int kIndexInFileMessages =
    2;

  friend void swap(AppID& a, AppID& b) {
    a.Swap(&b);
  }
  inline void Swap(AppID* other) {
    if (other == this) return;
  #ifdef PROTOBUF_FORCE_COPY_IN_SWAP
    if (GetOwningArena() != nullptr &&
        GetOwningArena() == other->GetOwningArena()) {
  ...
  void UnsafeArenaSwap(AppID* other) {
    if (other == this) return;
    ABSL_DCHECK(GetOwningArena() == other->GetOwningArena());
    InternalSwap(other);
  }
  ...
  AppID* New(::PROTOBUF_NAMESPACE_ID::Arena* arena = nullptr) const final {
    return CreateMaybeMessage<AppID>(arena);
  }
  using ::PROTOBUF_NAMESPACE_ID::Message::CopyFrom;
  void CopyFrom(const AppID& from);
  using ::PROTOBUF_NAMESPACE_ID::Message::MergeFrom;
  void MergeFrom( const AppID& from) {
    AppID::MergeImpl(*this, from);
  }
  private:
  static void MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg);
  public:
  ...
  protected:
  explicit AppID(::PROTOBUF_NAMESPACE_ID::Arena* arena);
  public:
  ...
  public:
  // @@protoc_insertion_point(class_scope:qst.AppID)
 private:
  class _Internal;
...
inline ::int32_t AppID::id() const {
  // @@protoc_insertion_point(field_get:qst.AppID.id)
  return _internal_id();
}
inline void AppID::set_id(::int32_t value) {
  _internal_set_id(value);
  // @@protoc_insertion_point(field_set:qst.AppID.id)
}
inline ::int32_t AppID::_internal_id() const {
  return _impl_.id_;
}
inline void AppID::_internal_set_id(::int32_t value) {
  ;
  _impl_.id_ = value;
}
